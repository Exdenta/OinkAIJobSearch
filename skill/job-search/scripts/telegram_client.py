...
def _web_search_listing_still_open(
    ...
    prompt = (
        ...
        "  GENERIC openings index. Tell-tale signs:\n"
        ...
        "    - Page <title> reads \"<Company> - Current Openings\",\n"
        "      \"All Jobs\", \"Careers at <Company>\", \"Open Roles\",\n"
        "      \"Job Openings\" instead of the SPECIFIC role title.\n"
        "    - The page lists MULTIPLE different roles (a roles grid\n"
        "      / search bar / filter chips) instead of one role's\n"
        "      description.\n"
        "    - The expected role title (provided below) does NOT\n"
        "      appear as an H1 / role header on the rendered page,\n"
        "      and the page is clearly a careers landing.\n"
